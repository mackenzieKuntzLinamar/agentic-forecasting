"""Prophet baseline helpers for the LNR LNR stock experiment.
...
class ProphetPredictor(Predictor):
    """Standard :class:`Predictor` wrapper for Prophet daily LNR forecasting."""
...
def lnr_series_to_price_df(data_service_series: pd.DataFrame) -> pd.DataFrame:
