...
> **Bootcamp note:** These patterns are demonstrated with LNR but the
...
# Assumes `benchmarks` dict is already loaded from lnr_benchmarks.json
...
The 15/30 thresholds are reasonable defaults for LNR. For a less volatile
