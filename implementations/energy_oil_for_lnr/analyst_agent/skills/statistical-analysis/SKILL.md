...
description: >-
  Diagnostic code patterns for interrogating the LNR price series you have
  ...
  code. Load references/lnr_benchmarks.json for historical benchmark values
...
| Field | Description |
|---|---|
| `target_history_csv` | LNR daily close history as a CSV string — recent 6 months daily, older history as weekly averages |
...
**`references/lnr_benchmarks.json`** — Pre-computed historical benchmark
...
1. Call `load_skill_resource("statistical-analysis", "references/lnr_benchmarks.json")`
