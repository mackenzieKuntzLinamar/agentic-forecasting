...
ROLLING_FORECAST_CACHE = DATA_DIR / "lnr_energy_case_study_forecasts_30d_daily_v3.parquet"
...
PROPHET_TRAJ_CACHE = DATA_DIR / "lnr_energy_prophet_trajectories.parquet"
PROPHET_SHOCK_TRAJ_CACHE = DATA_DIR / "lnr_energy_shock_prophet_trajectories.parquet"

# ── Agent JSON caches (NB3) ───────────────────────────────────────────────────
TRAJ_AGENT_CACHE = DATA_DIR / "lnr_energy_agent_trajectory_forecasts.json"
TRAJ_CONTEXT_CACHE = DATA_DIR / "lnr_energy_agent_trajectory_context.json"
SHOCK_ANALYST_CACHE = DATA_DIR / "lnr_energy_upshock_analyst_forecasts.json"
SHOCK_CONTEXT_CACHE = DATA_DIR / "lnr_energy_upshock_news_context.json"
SCENARIO_CACHE = DATA_DIR / "lnr_energy_agent_scenario_forecasts.json"
