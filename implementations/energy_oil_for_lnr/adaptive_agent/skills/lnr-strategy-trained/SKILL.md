...
|------|---------|-------------------|
| 2026-06-03 | In the 2025 LNR backtest, the trend-projection model underperformed a simple flat forecast across all regimes and horizons, with the most extreme errors occurring in the elevated volatility regime at the 21-day horizon (Trend MAE of 11.95 USD vs Flat MAE of 3.91 USD, and a negative bias of -3.03 USD). | — |
| 2026-06-03 | A full-year 2025 backtest (247 trading days) of LNR LNR stock prices shows that in the elevated volatility regime, the trend projection's MAE was more than double the flat forecast's MAE at 5bd (4.89 vs 2.33) and 10bd (5.28 vs 2.58), and more than triple at 21bd (11.95 vs 3.91), with a strong negative bias (-3.03) at 21bd. | hyp-001 |
| 2026-06-03 | In the 2025 LNR backtest, the trend-projection model underperformed the flat-trend forecast even in the normal volatility regime across all horizons (5bd: 2.60 vs 2.09, 10bd: 3.45 vs 2.83, 21bd: 4.56 vs 3.44). | — |
